...
**AI Coding 101** 是面向中国开发者的一站式 AI 辅助编程学习指南。

无论你是刚接触 AI 编程工具的新手，还是想要系统提升效率的老手，这里都有你需要的内容——从工具选型、提示词技巧到团队协作实践，从入门到进阶，一步步带你掌握 AI 编程的核心能力。
...
| 章节 | 内容 | 适合谁 |
|------|------|--------|
| [01 - 入门篇](./guides/01-getting-started.md) | 工具选型、安装配置、第一次 AI 编程 | 零基础 |
| [02 - 提示词篇](./guides/02-prompt-engineering.md) | 如何与 AI 对话、好坏提示词对比、上下文管理 | 初级 |
| [03 - 工作流篇](./guides/03-workflow-patterns.md) | TDD、Code Review、调试、重构、文档 | 中级 |
| [04 - 项目配置篇](./guides/04-project-setup.md) | CLAUDE.md、.cursorrules、项目级配置 | 中级 |
| [05 - 进阶篇](./guides/05-advanced-techniques.md) | 多 Agent、Git Worktree、MCP、自定义 Skills | 高级 |
| [06 - 团队协作篇](./guides/06-team-practices.md) | 团队引入 AI、共享配置、安全与成本 | 团队负责人 |
| [07 - 工具对比篇](./guides/07-tools-comparison.md) | 六大工具深度对比、定价、迁移方案 | 所有人 |

### 速查表

| 速查表 | 内容 |
|--------|------|
| [Claude Code 速查](./cheatsheets/claude-code.md) | 快捷键、斜杠命令、常用工作流 |
| [Cursor 速查](./cheatsheets/cursor.md) | 快捷键、功能、技巧 |
| [提示词模板](./cheatsheets/prompts.md) | 可直接复制的常用提示词模板 |

## 工具快速对比

| 特性 | Claude Code | Cursor | GitHub Copilot | Codex CLI | Gemini CLI |
|------|-------------|--------|----------------|-----------|------------|
| 类型 | 终端 Agent | IDE（VS Code fork） | IDE 插件 | 终端 Agent | 终端 Agent |
...
加入我们的 QQ 群交流 AI 编程心得：

- QQ 群号：**833585047**

欢迎提交 PR、Issue 或在 Discussion 中分享你的经验。
